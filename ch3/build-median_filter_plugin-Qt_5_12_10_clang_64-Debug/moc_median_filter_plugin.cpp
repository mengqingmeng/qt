...
#include <memory>
#include "../median_filter_plugin/median_filter_plugin.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_median_filter_plugin_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_median_filter_plugin_t qt_meta_stringdata_median_filter_plugin = {
    {
QT_MOC_LITERAL(0, 20) // "median_filter_plugin"
...
const QMetaObject median_filter_plugin::staticMetaObject = { {
    ...
    qt_meta_stringdata_median_filter_plugin.offsetsAndSize,
...
static constexpr unsigned char qt_pluginMetaData_median_filter_plugin[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
